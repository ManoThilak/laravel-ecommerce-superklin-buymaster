...
<div class="modal" id="popup-modal-withdraw">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <center>
                            <h2 class="__color-8a8a8a">
                                <i class="tio-wallet-outlined nav-icon"></i> You have new Withdraw request from Seller
                            </h2>
                            <hr>
                            <button onclick="check_withdraw()" class="btn btn--primary">Ok, let me check</button>
                        </center>
                    </div>
                </div>
            </div>
...
<div class="modal" id="popup-modal-withdrawd">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <center>
                            <h2 class="__color-8a8a8a">
                                <i class="tio-wallet-outlined nav-icon"></i> You have new Withdraw request from DeliveryMan
                            </h2>
                            <hr>
                            <button onclick="check_withdrawd()" class="btn btn--primary">Ok, let me check</button>
                        </center>
                    </div>
                </div>
            </div>
