...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/get-withdraw-data', 'SystemController@withdraw_data')->name('get-withdraw-data');
        Route::get('/get-withdrawd-data', 'SystemController@withdrawd_data')->name('get-withdrawd-data');
